...
**Where**: University of Guelph: 50 Stone Road East, Guelph. Room 2114 DB (TEL). [Google maps](https://goo.gl/maps/fLeskquHNZs)
...
Time   | Goal
-------|------------
1:10   | Meet & greet. Test software
1:30  | [R arithmetic and simple commands](R.basics//r.basics.html)
2:00  | [R environment and visualization](R.basics//r.basics.html)
2:15  | *coffee break*
2:30  | [Introduction to GLMs](GLM.intro//GLM.intro.html)
3:00  | [Conducting GLMs in R](GLM.intro//GLM.intro.html)
3:30  | Activity
